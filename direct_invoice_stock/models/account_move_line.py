...
class AccountMoveLine(models.Model):
    ...
    def _onchange_analytic_distribution_set_warehouse(self):
        """Auto-set warehouse on invoice when analytic account is selected"""
        if self.analytic_distribution and self.move_id and self.move_id.move_type == 'out_invoice':
            ...
            if analytic_dict:
                try:
                    ...
                    if analytic_account:
                        ...
                        if warehouse and not self.move_id.warehouse_id:
                            self.move_id.warehouse_id = warehouse
                            _logger.info(
