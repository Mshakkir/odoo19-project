...
class ReportProfitLossPDF(models.AbstractModel):
    ...
    _description = 'Custom Profit and Loss PDF Report (Warehouse-wise)'

    @api.model
    def _get_report_values(self, docids, data=None):
        """Compute warehouse-wise Profit & Loss using analytic_distribution JSON"""
        ...
        for doc in docs:
            if hasattr(doc, 'warehouse_analytic_ids') and doc.warehouse_analytic_ids:
                ...
                # No analytic filter → entire company totals
