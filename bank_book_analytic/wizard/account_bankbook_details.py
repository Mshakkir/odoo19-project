...
class AccountBankBookDetailsLine(models.TransientModel):
    ...
    details_id = fields.Many2one('account.bankbook.details', string='Details', related='account_id.details_id', store=True)
    account_code = fields.Char(string='Account Code', related='account_id.account_code', store=True)
    account_name = fields.Char(string='Account Name', related='account_id.account_name', store=True)
