...
class PurchaseReportByPartyGroupWizard(models.TransientModel):
    _name = 'purchase.report.by.party.group.wizard'
    _description = 'Purchase Report By Party Group Wizard'
    ...
    category_ids = fields.Many2many('res.partner.category', string='Vendor Tags')
