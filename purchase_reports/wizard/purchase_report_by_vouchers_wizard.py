...
class PurchaseReportByVouchersWizard(models.TransientModel):
    _name = 'purchase.report.by.vouchers.wizard'
    _description = 'Purchase Report By Vouchers Wizard'
