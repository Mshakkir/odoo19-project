...
class AccountingReport(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        _logger.info(f"Analytic IDs: {self.analytic_account_ids.ids}")
        ...
        if self.analytic_account_ids and self.analytic_filter_mode == 'separate':
            ...
            report_ref = 'accounting_pdf_reports_analytic.action_report_financial_separate_analytic'
        elif self.analytic_account_ids:
            _logger.info("Using COMBINED template")
            report_ref = 'accounting_pdf_reports_analytic.action_report_financial_combined_analytic'
        else:
            _logger.info("Using ORIGINAL template")
