...
class AccountingReportAnalytic(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        # 👇 Use existing Odoo Mates balance sheet report action
        return self.env.ref('accounting_pdf_reports.action_report_financial').with_context(landscape=True).report_action(self, data=data)
