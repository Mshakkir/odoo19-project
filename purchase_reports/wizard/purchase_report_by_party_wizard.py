...
class PurchaseReportByPartyWizard(models.TransientModel):
    _name = 'purchase.report.by.party.wizard'
    _description = 'Purchase Report By Party Wizard'
