    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account):
        ...
        sql = ('''
            ...
            GROUP BY l.id, l.account_id, l.date, j.code, l.currency_id, l.amount_currency, 
                     l.ref, l.name, m.name, c.symbol, p.name, l.analytic_distribution
            ORDER BY ''' + sql_sort
        )
    ...
    def _get_analytic_info(self, analytic_distribution):
        ...
        try:
            ...
            if analytic_ids:
                ...
                result['names'] = ', '.join(analytics.mapped('name'))
        except:
            pass
...
class ReportBankBookAnalyticDetails(models.AbstractModel):
    _name = 'report.bank_book_analytic.report_bankbook_analytic_details'
    _description = 'Bank Book Details with Analytic Accounts'
    _inherit = 'report.bank_book_analytic.report_bankbook_analytic'
