...
class ProductCategoryInvoiceReport(models.Model):
    _name = 'product.category.invoice.report'
    _description = 'Product Category Invoice Report'
    _auto = False
    _rec_name = 'categ_id'
    ...
    def init(self):
        """Create SQL view for product category invoice report"""
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        res = super(ProductCategoryInvoiceReport, self).read_group(domain, fields, groupby, offset=offset, limit=limit,
