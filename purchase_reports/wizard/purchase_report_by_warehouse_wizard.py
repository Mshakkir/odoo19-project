...
class PurchaseReportByWarehouseWizard(models.TransientModel):
    _name = 'purchase.report.by.warehouse.wizard'
    _description = 'Purchase Report By Warehouse Wizard'
    ...
    def action_generate_report(self):
        ...
        return {
            ...
            'name': 'Purchase Report - By Warehouse',
