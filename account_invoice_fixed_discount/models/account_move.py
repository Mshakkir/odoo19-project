...
class AccountMove(models.Model):
    ...
    global_discount_fixed = fields.Monetary(
        ...
        default=0.0,
        currency_field="currency_id",
        help="Apply a fixed discount to the entire invoice.",
        tracking=True,
        states={'posted': [('readonly', True)]},
    )

    # REMOVED: _onchange_global_discount_fixed method
    # REMOVED: write method override
    # REMOVED: create method override