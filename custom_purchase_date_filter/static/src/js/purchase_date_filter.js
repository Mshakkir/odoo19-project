    ...
    injectPurchaseFilter() {
        ...
        <div class="purchase_date_filter_wrapper_main">
            <div class="date_filter_wrapper">
                ...
                <div class="filter_group">
                    <label>To</label>
                    <input type="date" id="${toId}" value="${today}" class="form-control"/>
                </div>
                ...
                <div class="filter_group">
                    ...
                    <select id="${analyticId}" class="form-select">
                ...
                <div class="filter_actions">
                    <button id="${applyId}" class="btn btn-primary">Apply</button>
                    <button id="${clearId}" class="btn btn-secondary">Clear</button>
                </div>
            </div>
        </div>
        `;
    ...
    attachEvents(ids) {
        ...
        const apply = () => {
            ...
            if (viewType === "bill") {
                ...
                if (from) domain.push(["invoice_date", ">=", from]);
                if (to) domain.push(["invoice_date", "<=", to]);
            } else {
                if (from) domain.push(["date_order", ">=", from + " 00:00:00"]);
                if (to) domain.push(["date_order", "<=", to + " 23:59:59"]);
            }
