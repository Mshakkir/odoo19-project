...
#             else:
#                 line.price_subtotal_before_discount = 0.0
#
...
class AccountMoveLine(models.Model):
    ...
    def _compute_tax_before_discount(self):
        ...
        for line in self:
            if not line.display_type and line.tax_ids:
                ...
                line.price_tax_before_discount = taxes_res["total_included"] - taxes_res["total_excluded"]
            else:
