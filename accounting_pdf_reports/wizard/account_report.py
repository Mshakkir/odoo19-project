...
class AccountingReport(models.TransientModel):
    ...
    label_filter = fields.Char(
        string='Column Label',
        help="This label will be displayed on report to "
    ...
    debit_credit = fields.Boolean(
        ...
        help="This option allows you to get more details about "
             "the way your balances are computed. Because it is "
             "space consuming, we do not allow its use with comparison."
    )

    # ✅ Added new analytic fields
    ...
    def _print_report(self, data):
        data['form'].update(self.read([
            ...
            'analytic_filter', 'analytic_account_ids'
        ])[0])
