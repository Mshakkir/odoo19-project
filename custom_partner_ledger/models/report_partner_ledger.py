...
class ReportPartnerLedgerCustom(models.AbstractModel):
    ...
    def _lines(self, data, partner):
        ...
        query = """
          SELECT "account_move_line".id, "account_move_line".date, j.code, acc.display_name as a_code, acc.name as a_name,
    ...
    def _get_report_values(self, docids, data=None):
        ...
        # Get partner type information - REQUIRED by template
        ...
        res.update({
            ...
            'partner_type_info': partner_type_info,  # REQUIRED by your template
