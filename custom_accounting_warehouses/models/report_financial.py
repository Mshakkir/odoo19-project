...
class ReportFinancialInherit(models.AbstractModel):
    ...
    def _compute_account_balance(self, accounts):
        ...
        # Build base query using existing _query_get (provides domain filters & joins)
        ...
        # Prefer explicit values passed from wizard via context
        ...
        if analytic_account_ids:
            analytic_exists = (
                ' AND EXISTS (SELECT 1 FROM account_analytic_line aal '
