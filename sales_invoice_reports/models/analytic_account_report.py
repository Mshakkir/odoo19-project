...
class AnalyticAccountInvoiceReport(models.Model):
    _name = 'analytic.account.invoice.report'
    _description = 'Analytic Account Invoice Report'
    _auto = False
    ...
    def init(self):
        """Create SQL view for analytic account invoice report"""
        ...
        query = """
            CREATE OR REPLACE VIEW %s AS (
                ...
                WHERE
                    ...
                    AND ail.analytic_distribution IS NOT NULL
                    AND ail.analytic_distribution != '{}'::jsonb
            )
        """ % self._table
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        res = super(AnalyticAccountInvoiceReport, self).read_group(domain, fields, groupby, offset=offset, limit=limit,
