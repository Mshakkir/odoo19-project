...
patch(ListController.prototype, {
    ...
    async loadPurchaseFilterData() {
        try {
            ...
            // Load vendors - FIX: Only fetch id and name fields
                    ...
                    <div class="date_filter_wrapper">
                        ...
                        <div class="filter_group autocomplete_group">
                            ...
                            <div class="autocomplete_wrapper">
                                <input type="text" class="form-control autocomplete_input" id="${vendorId}_input" placeholder="Vendor" autocomplete="off" />
                        ...
                        <div class="filter_group autocomplete_group">
                            ...
                            <div class="autocomplete_wrapper">
                                <input type="text" class="form-control autocomplete_input" id="${repId}_input" placeholder="Purchase Rep" autocomplete="off" />
                ...
                <div class="purchase_date_filter_container">
                    <div class="date_filter_wrapper">
                        ...
                        <div class="filter_group autocomplete_group">
                            ...
                            <div class="autocomplete_wrapper">
                                <input type="text" class="form-control autocomplete_input" id="${repId}_input" placeholder="Buyer" autocomplete="off" />
                                <input type="hidden" id="${repId}_value" />
                                <div class="autocomplete_dropdown" id="${repId}_dropdown"></div>
                            </div>
                        </div>
    ...
    filterPurchaseAutocomplete(fieldId, dataList, searchTerm) {
        ...
        // FIX: Only display name, not all properties
