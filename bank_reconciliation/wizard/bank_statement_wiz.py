...
class BankStatement(models.Model):
    ...
    def _get_reconcile_accounts(self):
        """Get all accounts that need to be reconciled including POS payment method accounts"""
        self.ensure_one()
        ...
        # Add POS payment method accounts
    ...
    def _compute_amount(self):
        ...
        for record in self:
            ...
            # Get all accounts to consider (bank + POS payment methods)
