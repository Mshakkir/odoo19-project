...
class PurchaseReportByCategoryWizard(models.TransientModel):
    _name = 'purchase.report.by.category.wizard'
    _description = 'Purchase Report By Product Category Wizard'
    ...
    def action_generate_report(self):
        ...
        return {
            ...
            'name': 'Purchase Report - By Product Category',
