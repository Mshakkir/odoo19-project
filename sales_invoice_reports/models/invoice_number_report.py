...
class InvoiceNumberReport(models.Model):
    _name = 'invoice.number.report'
    _description = 'Invoice Number Report'
    _auto = False
    ...
    def init(self):
        """Create SQL view for invoice number report"""
    ...
    def read_group(self, domain, fields, groupby, offset=0, limit=None, orderby=False, lazy=True):
        ...
        res = super(InvoiceNumberReport, self).read_group(domain, fields, groupby, offset=offset, limit=limit,
